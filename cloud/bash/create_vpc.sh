...
YC_NETWORK_NAME=ap-golovko-dataproc-network
YC_SUBNET_NAME=ap-golovko-dataproc-subnet
YC_ROUTE_TABLE_NAME=ap-golovko-dataproc-route-table
YC_NAT_GATEWAY_NAME=ap-golovko-dataproc-nat-gateway
YC_SECURITY_GROUP_NAME=ap-golovko-dataproc-security-group
